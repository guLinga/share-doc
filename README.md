...
9. 写日记的时候使用函数防抖将日记自动同步到数据库。

10. 日记导出功能，可以将全部日记拼接起来导出一篇pdf。

11. 去除了封装的录音class，重新封装了录音hook，并实现了音频可视化功能。

12. 重新写了一套俄罗斯方块，以前的那一套有问题，第一个方块不会从顶部开始。

13. 结合electron封装邮件菜单hook。
